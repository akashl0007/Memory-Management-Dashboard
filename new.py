            ...
            if highest_memory_process:
                ...
                if choice == 'y':
                    process = psutil.Process(
                        highest_memory_process.info['pid'])
                    process.terminate()
                    print(
                        f"Process '{highest_memory_process.info['name']}' (PID: {highest_memory_process.info['pid']}) has been terminated.")
                elif choice == 'n':
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            application_name = input(
                "Enter the name of the application to stop: ")
